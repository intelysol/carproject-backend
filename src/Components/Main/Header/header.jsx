...
const Header = () => {
    ...
    const logoutHandler = async () => {
        let getData = await localStorage.getItem('ud');
        if (getData) {
    ...
    //! Handler for change theme mode...
    const changeTheme = (themeValue) => {
        if (themeValue == 'dark-mode') {
            document.getElementById('bodyThemeID').classList.remove('light-mode');
            document.getElementById('bodyThemeID').classList.add('dark-mode');
            localStorage.setItem('themeState', 'dark-mode');
        }
        else {
            if (themeValue == 'light-mode') {
                document.getElementById('bodyThemeID').classList.remove('dark-mode');
                document.getElementById('bodyThemeID').classList.add('light-mode');
                localStorage.setItem('themeState', 'light-mode');
            }
        }
    };
            ...
            <div className="app-header header sticky">
                <div className="container-fluid main-container">
                    <div className="d-flex">
                        ...
                        {/* <!-- LOGO --> */}
                        <div className="main-header-center ms-3 d-none d-xl-block">
                        ...
                        <div className="d-flex order-lg-2 ms-auto header-right-icons">
                            ...
                            <button className="navbar-toggler navresponsive-toggler d-md-none ms-auto" type="button"
                            ...
                            <div className="navbar navbar-collapse responsive-navbar p-0">
                                <div className="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div className="d-flex order-lg-2">
                                        <div className="dropdown d-md-none d-flex">
                                            <a href="#" className="nav-link icon" data-bs-toggle="dropdown">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="header-icon" enableBackground="new 0 0 24 24" viewBox="0 0 24 24"><path d="M21.2529297,17.6464844l-2.8994141-2.8994141c-0.0021973-0.0021973-0.0043945-0.0043945-0.0065918-0.0065918c-0.8752441-0.8721313-2.2249146-0.9760132-3.2143555-0.3148804l-0.8467407-0.8467407c1.0981445-1.2668457,1.7143555-2.887146,1.715332-4.5747681c0.0021973-3.8643799-3.1286621-6.9989014-6.993042-7.0011597S2.0092773,5.1315308,2.007019,8.9959106S5.1356201,15.994812,9,15.9970703c1.6889038,0.0029907,3.3114014-0.6120605,4.5789185-1.7111206l0.84729,0.84729c-0.6630859,0.9924316-0.5566406,2.3459473,0.3208618,3.2202759l2.8994141,2.8994141c0.4780884,0.4786987,1.1271973,0.7471313,1.8037109,0.7460938c0.6766357,0.0001831,1.3256226-0.2686768,1.803894-0.7472534C22.2493286,20.2558594,22.2488403,18.6417236,21.2529297,17.6464844z M9.0084229,14.9970703c-3.3120728,0.0023193-5.9989624-2.6807861-6.0012817-5.9928589S5.6879272,3.005249,9,3.0029297c1.5910034-0.0026855,3.1175537,0.628479,4.2421875,1.7539062c1.1252441,1.1238403,1.7579956,2.6486206,1.7590942,4.2389526C15.0036011,12.3078613,12.3204956,14.994751,9.0084229,14.9970703z M20.5458984,20.5413818c-0.604126,0.6066284-1.5856934,0.6087036-2.1923828,0.0045166l-2.8994141-2.8994141c-0.2913818-0.2910156-0.4549561-0.6861572-0.4544678-1.0979614C15.0006714,15.6928101,15.6951294,15,16.5507812,15.0009766c0.4109497-0.0005493,0.8051758,0.1624756,1.0957031,0.453125l2.8994141,2.8994141C21.1482544,18.9584351,21.1482544,19.9364624,20.5458984,20.5413818z" /></svg>
                                            </a>
                                            <div className="dropdown-menu header-search dropdown-menu-start">
                                                <div className="input-group w-100 p-2">
                                                    <input type="text" className="form-control" placeholder="Search...." />
                                        ...
                                        <div className="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a className="nav-link icon text-center country-nav-link" data-bs-target="#country-selector" data-bs-toggle="modal">
                                                <img className="header-icons language" alt="" src="../assets/images/flags/us_flag.jpg" />
                                            </a>
                                        </div>
                                        <div className="dropdown  d-flex">
                                            <a className="nav-link icon theme-layout nav-link-bg layout-setting">
                                                <span className="dark-layout" onClick={() => { changeTheme('dark-mode') }}>
                                                ...
                                                <span className="light-layout" onClick={() => { changeTheme('light-mode') }}>
                                        ...
                                        <div className="dropdown  d-flex shopping-cart">
                                            <a className="nav-link icon text-center" data-bs-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <span className="badge bg-info header-badge">4</span>
                                            </a>
                                            <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div className="drop-heading border-bottom">
                                                    <div className="d-flex">
                                                        <h6 className="mt-1 mb-0 fs-15 text-dark">Shopping Cart</h6>
                                                        <div className="ms-auto">
                                                            <span className="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill"> <a className="showall-text text-white">Remove All</a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a className="dropdown-item d-flex p-4" href="cart.html">
                                                        <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/1.jpg"></span>
                                                        <div className="wp-60 cart-desc mt-1">
                                                            <p className="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">TrueBasket Metal Single Pot</p>
                                                            <p className="fs-12 fw-300 lh-1 mb-0">Status: <span className="text-green">In Stock</span></p>
                                                            <span className="fs-12 fw-300 lh-1 mb-0">Quantity: 01</span>
                                                        </div>
                                                        <div className="ms-auto text-end d-flex fs-16">
                                                            <span className="fs-16 text-dark d-none d-sm-block fw-semibold">
                                                                $129
                                                            </span>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item d-flex p-4" href="cart.html">
                                                        <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/2.jpg"></span>
                                                        <div className="wp-60 cart-desc mt-1">
                                                            <p className="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">Authentic chair with Canopy</p>
                                                            <p className="fs-12 fw-300 lh-1 mb-0">Status: <span className="text-green">In Stock</span></p>
                                                            <span className="fs-12 fw-300 lh-1 mb-0">Quantity: 03</span>
                                                        </div>
                                                        <div className="ms-auto text-end d-flex fs-16">
                                                            <span className="fs-16 text-dark d-none d-sm-block fw-semibold">
                                                                $99
                                                    ...
                                                    <a className="dropdown-item d-flex p-4" href="cart.html">
                                                        <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/3.jpg"></span>
                                                        <div className="wp-60 cart-desc mt-1">
                                                            <p className="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">Casual Sneakers Canvas</p>
                                                            <p className="fs-12 fw-300 lh-1 mb-0">Status: <span className="text-green">In Stock</span></p>
                                                            <span className="fs-12 fw-300 lh-1 mb-0">Quantity: 03</span>
                                                        </div>
                                                        <div className="ms-auto text-end d-flex fs-16">
                                                    ...
                                                    <a className="dropdown-item d-flex p-4" href="cart.html">
                                                        <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/4.jpg"></span>
                                                        <div className="wp-60 cart-desc mt-1">
                                                            <p className="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">Branded Head Phones</p>
                                                            <p className="fs-12 fw-300 lh-1 mb-0">Status: <span className="text-danger">No Stock</span></p>
                                                            <span className="fs-12 fw-300 lh-1 mb-0">Quantity: 01</span>
                                                        </div>
                                                        <div className="ms-auto text-end d-flex fs-16">
                                                            <span className="fs-16 text-dark d-none d-sm-block fw-semibold">
                                                    ...
                                                    <a className="dropdown-item d-flex p-4" href="cart.html">
                                                        <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/5.jpg"></span>
                                                        <div className="wp-60 cart-desc mt-1">
                                                            <p className="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">camera lens (16mm f/1.4)</p>
                                                            <p className="fs-12 fw-300 lh-1 mb-0">Status: <span className="text-green">In Stock</span></p>
                                                            <span className="fs-12 fw-300 lh-1 mb-0">Quantity: 02</span>
                                                        </div>
                                                        <div className="ms-auto text-end d-flex fs-16">
                                                            <span className="fs-16 text-dark d-none d-sm-block fw-semibold">
                                                                $1,279
                                        ...
                                        <div className="dropdown d-md-flex message">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
                                                <div className="drop-heading border-bottom">
                                                    <div className="d-flex">
                                                        <h6 className="mt-1 mb-0 fs-15 text-dark">Messages</h6>
                                                        <div className="ms-auto">
                                                            <span className="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill"> <a className="showall-text text-white">Clear</a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="message-menu ps2 overflow-hidden">
                                                    <a className="dropdown-item d-flex" href="chat.html">
                                                        {/* <span className="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="../assets/images/users/1.jpg" style="background: url(&quot;../assets/images/users/1.jpg&quot;) center center;"></span> */}
                                                        <div className="wd-90p">
                                                            <div className="d-flex">
                                                                <h5 className="mb-1">Hawaii Hilton</h5>
                                                                <small className="text-muted ms-auto text-end"> 11.07 am </small>
                                                            </div>
                                                            <span className="fs-12 text-muted">Wanted to submit project by tomorrow....</span>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item d-flex" href="chat.html">
                                                        {/* <span className="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="../assets/images/users/15.jpg" style="background: url(&quot;../assets/images/users/15.jpg&quot;) center center;"> */}
                                                        {/* </span> */}
                                                        <div className="wd-90p">
                                                            <div className="d-flex">
                                                                <h5 className="mb-1">Hermoini</h5>
                                                                <small className="text-muted ms-auto text-end"> 12.32 am </small>
                                                            </div>
                                                            <span className="fs-12 text-muted">Planning for next big update......</span>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item d-flex" href="chat.html">
                                                        {/* <span className="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="../assets/images/users/12.jpg" style="background: url(&quot;../assets/images/users/12.jpg&quot;) center center;"> */}
                                                        {/* </span> */}
                                                        <div className="wd-90p">
                                                            <div className="d-flex">
                                                                <h5 className="mb-1">Buenda osas</h5>
                                                                <small className="text-muted ms-auto text-end"> 2:17 am </small>
                                                            </div>
                                                            <span className="fs-12 text-muted">Ready to submit future data...</span>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item d-flex" href="chat.html">
                                                        {/* <span className="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="../assets/images/users/4.jpg" style="background: url(&quot;../assets/images/users/4.jpg&quot;) center center;"> */}
                                                        {/* </span> */}
                                                        <div className="wd-90p">
                                                            <div className="d-flex">
                                                                <h5 className="mb-1">Gabby gibson</h5>
                                                                <small className="text-muted ms-auto text-end"> 7:55 am </small>
                                                            </div>
                                                            <span className="fs-12 text-muted">Cleared all statistics from last year......</span>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div className="dropdown-divider m-0"></div>
                                                <div className="text-center p-3">
                                                    <a className="btn btn-primary">View All Messages</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="dropdown d-md-flex notifications">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div className="drop-heading border-bottom">
                                                    <div className="d-flex">
                                                        <h6 className="mt-1 mb-0 fs-15 text-dark">Notifications</h6>
                                                        <div className="ms-auto">
                                                            <span className="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill"> <a className="showall-text text-white">Clear</a> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="notifications-menu ps3 overflow-hidden">
                                                    <a className="dropdown-item" href="chat.html">
                                                        <div className="notification-each d-flex">
                                                            <div className="me-3 notifyimg  bg-primary brround">
                                                                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24"><path d="M17.4541016,11H6.5458984c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h10.9082031c0.276123,0,0.5-0.223877,0.5-0.5S17.7302246,11,17.4541016,11z M19.5,2h-15C3.119812,2.0012817,2.0012817,3.119812,2,4.5v11c0.0012817,1.380188,1.119812,2.4987183,2.5,2.5h12.7930298l3.8534546,3.8535156C21.2402344,21.9473267,21.3673706,22,21.5,22c0.276123,0,0.5-0.223877,0.5-0.5v-17C21.9987183,3.119812,20.880188,2.0012817,19.5,2z M21,20.2929688l-3.1464844-3.1464844C17.7597656,17.0526733,17.6326294,17,17.5,17h-13c-0.828064-0.0009155-1.4990845-0.671936-1.5-1.5v-11C3.0009155,3.671936,3.671936,3.0009155,4.5,3h15c0.828064,0.0009155,1.4990845,0.671936,1.5,1.5V20.2929688z M17.4541016,8H6.5458984c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h10.9082031c0.276123,0,0.5-0.223877,0.5-0.5S17.7302246,8,17.4541016,8z" /></svg>
                                                            </div>
                                                            <div>
                                                                <span className="notification-label mb-1">New Message Received</span>
                                                                <span className="notification-subtext text-muted">2 hours ago</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item" href="chat.html">
                                                        <div className="notification-each d-flex">
                                                            <div className="me-3 notifyimg  bg-secondary brround">
                                                            ...
                                                            <div>
                                                                <span className="notification-label mb-1">New Mail Received</span>
                                                                <span className="notification-subtext text-muted">1 week ago</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item" href="cart.html">
                                                        <div className="notification-each d-flex">
                                                            <div className="me-3 notifyimg  bg-info brround">
                                                            ...
                                                            <div>
                                                                <span className="notification-label mb-1">New Order Received</span>
                                                                <span className="notification-subtext text-muted">1 day ago</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a className="dropdown-item" href="blog-details.html">
                                                        <div className="notification-each d-flex">
                                                            <div className="me-3 notifyimg  bg-warning brround">
                                                            ...
                                                            <div>
                                                                <span className="notification-label mb-1">New Comment Received</span>
                                                                <span className="notification-subtext text-muted">1 day ago</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div className="dropdown-divider m-0"></div>
                                                <div className="text-center p-3">
                                                    <a className="btn btn-primary">View All Notifications</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="dropdown d-md-flex profile-1">
                                            <a href="#" data-bs-toggle="dropdown" className="nav-link pe-2 leading-none d-flex animate">
                                                <span>
                                                    {
                                                        userData !== null ?
                                                            <img src={require(`../../../../public/uploads/userProfileImages/${userData.pictureUrl}`)} alt="profile-user"
