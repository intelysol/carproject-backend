...
const CarDetailsEditForm = () => {
  ...
  useEffect(() => {
    ...
    setCarBrandName(location.state.data.carBrandName);
    setCarType(location.state.data.carType);
    setCarDealerCompanyName(location.state.data.carDealerCompanyName);
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap" }}>
                    ...
                    <div className="col-md-6">
                      ...
                      {toolsCharges.trim().length < 1 ? (
                        ...
                        >
                          Please enter updated tools charges
                        </label>
                      ) : (
                        <label
                          htmlFor="validationCustom01"
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  <div className="col-md-3">
                    ...
                    {minimumDriverAge.trim().length < 2 ? (
                      ...
                      >
                        Please enter updated minimum age
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-3">
                    ...
                    <input
                      ...
                      style={{
                        borderColor:
                          refundedIn.trim().length < 1 ? "red" : "#8fbd56",
                      }}
                    />
