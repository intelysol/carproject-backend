...
const FaqEditForm = () => {
  ...
  const apiCall = async (faqHeading, faqType, faqDescription, status, id) => {
    ...
    try {
      let response = await axios({
        method: "PUT",
        url: apiUrl,
        data: { faqHeading, faqType, faqDescription, status, id },
      });
            ...
            <div className="card-body">
              ...
              >
                ...
                <div className="col-12">
                  ...
                  <div className="btn btn-primary" onClick={editFaqData}>
                    Update
                  </div>
                </div>
              </form>
