...
const AreaEditForm = () => {
  ...
  const apiCall = async (
    ...
    try {
      let response = await axios({
        method: "PUT",
        url: apiUrl,
        data: { areaName, cityName, latitude, longitude, status, id },
      });
  ...
  const editAreaData = async () => {
    if (areaName.trim() == "" || cityName.trim() == "" || !rowID) {
      setModalStatus(true);
      setModalData({
        heading: "Error: Cannot process your update entry!",
        title: "Please select city or enter updated area name",
        title2: "Make sure you entered correct details",
        statusCode: "400",
      });
      setTimeout(() => {
            ...
            <div className="card-body">
              ...
              >
                ...
                <div className="col-12">
                  ...
                  <div className="btn btn-primary" onClick={editAreaData}>
                    Update
                  </div>
                </div>
              </form>
